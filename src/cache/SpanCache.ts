...
export default class SpanCache<Pojo = any> {
  ...
  private _gte(a: SpanCacheKeyType, b: SpanCacheKeyType): boolean {
  ...
  private _lt(a: SpanCacheKeyType, b: SpanCacheKeyType): boolean {
    if (typeof a === 'string' && typeof b === 'string') {
      return parseInt(a, 10) < parseInt(b, 10);
    }
    // @ts-ignore
  ...
  private _lte(a: SpanCacheKeyType, b: SpanCacheKeyType): boolean {
    if (typeof a === 'string' && typeof b === 'string') {
      return parseInt(a, 10) <= parseInt(b, 10);
    }
    // @ts-ignore
  ...
  private _gt(a: SpanCacheKeyType, b: SpanCacheKeyType): boolean {
    if (typeof a === 'string' && typeof b === 'string') {
      return parseInt(a, 10) > parseInt(b, 10);
    }
    // @ts-ignore
   ...
   * @param datas
   */
  async saveToCache(param: Span, datas: Pojo[],saveOpt?:SaveOpt) {
