...
class JsonUtil {
     ...
     * @param cols
     */
    static addObj(obj1, obj2, cols) {
        var _a, _b;
        let ret = {};
        for (let col of cols) {
            let val1 = (_a = this.getByKeys(obj1, col)) !== null && _a !== void 0 ? _a : 0;
            let val2 = (_b = this.getByKeys(obj2, col)) !== null && _b !== void 0 ? _b : 0;
    ...
    */
    ...
    static change(changer, obj) {
        if (!(changer instanceof Array)) {
            changer = [changer];
        }
        let jsonChanger = new ArrayJSONChanger_1.default(changer);
        return jsonChanger.change(obj);
    }
    static reverse(changer, obj) {
        if (!(changer instanceof Array)) {
            changer = [changer];
        }
        let jsonChanger = new ArrayJSONChanger_1.default(changer);
