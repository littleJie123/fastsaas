    ...
    '#d': function (array) {
        ...
        return function (params) {
            ...
            if (now == null || params == null || params[now] == null)
                today = DateUtil_1.DateUtil.today();
            else {
                today = DateUtil_1.DateUtil.parse(params[now]);
            }
            if (numDays < 0)
                return DateUtil_1.DateUtil.beforeDay(today, numDays * -1);
            return DateUtil_1.DateUtil.afterDay(today, numDays);
        };
    }
};
class ParseFun {
    static get(key, array) {
...
class BeanUtil {
  ...
  */
   ...
   */
     ...
     * @param params
     */
    static deepParseJson(obj, ...params) {
        if (obj == null)
            return null;
        if (obj instanceof Array) {
            let retList = [];
    ...
    static changeVal(val, ...params) {
        ...
        let strVal = StrUtil_1.StrUtil.trim(val.toString());
            ...
            if (strVal.startsWith('#')) {
                ...
                for (let param of params) {
                    if (!(param instanceof Array)) {
                        let paramVal = JsonUtil_1.default.getByKeys(param, strVal);
                        if (paramVal != null) {
                            return paramVal;
                        }
                    }
                        ...
                        let paramVal = ArrayUtil_1.ArrayUtil.toArray(param, strVal);
